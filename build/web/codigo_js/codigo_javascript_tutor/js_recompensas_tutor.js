...
// Mostrar el modal de creación de actividad
...
function limpiarFormulario() {
    ...
    console.log("Menús de opciones de color e íconos cerrados.");
...
function updateAlignment() {
    ...
    if (isErrorVisible) {
        ...
        console.log("Alineación cambiada a 'center' para iconColorContainer.");
    } else {
        iconColorContainer.style.alignItems = "flex-end";
        console.log("Alineación cambiada a 'flex-end' para iconColorContainer.");
    }
}
// Llamar la función cuando sea necesario, por ejemplo, después de validar el formulario
console.log("Llamando a updateAlignment...");
updateAlignment();
...
// Recompensas de Tecnología
    ...
    // Recompensas de Entretenimiento (Aqui nos quedamos con los iconos)
