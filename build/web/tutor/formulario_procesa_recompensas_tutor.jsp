    ...
    <body>
        <%
            ...
            if (!valid) {
                ...
                response.sendRedirect("formulario_procesa_recompensas_tutor.jsp");
                return;
            }
            ...
            try {
                ...
                if (rs.next() && rs.getInt(1) > 0) {
                    ...
                    response.sendRedirect("recompensas_tutor.jsp"); // Redirige a la página de recompensas
                ...
                if (rowsAffected > 0) {
                    ...
                    if (generatedKeys.next()) {
                        ...
                        response.sendRedirect("recompensas_tutor.jsp"); // Redirige a la página de premios
                    }
                } else {
