                ...
                <div class="imagen" 
                    ...
                    <div class="flechitas" id="reclamados">
                        ...
                        <div class="flechas-container">
                            <div class="fle" onclick="window.location.href = 'recompensas_tutor_1.jsp';" style="cursor: pointer;">
                        ...
                        <div class="prem" >
                            <%
                                ...
                                try (PreparedStatement pstmt = conn.prepareStatement(query5)) {
                                    pstmt.setInt(1, Integer.parseInt(idKit)); // Usa el idKit que ya tienes
                                    ResultSet rs = pstmt.executeQuery();
                                    while (rs.next()) {
                            ...
                            %>
                            <div class="premio" data-id="<%= rs.getInt("idPremio")%>" data-estado="<%= estadoPremio%>" data-favorito="<%= favorito%>" data-kit="<%= idKit%>">
...
// Función para mostrar premios
                            ...
                            function cambiarEstado(element, tipo) {
                                ...
                                if (tipo === 'premio') {
                                    ...
                                    fetch('recompensas_tutor.jsp?idPremio=' + idPremio + '&estado=' + nuevoEstado + '&favorito=' + favoritoActual)
                                            .then(response => {
                                                if (!response.ok)
                                            ...
                                            .then(data => {
                                                ...
                                                if (nuevoEstado === 0) {
                                                    ...
                                                    actualizarContenido();
                                                    location.reload();
                                                }// Actualiza el contenido de forma imperceptible
                                            })
                                    ...
                                    fetch('recompensas_tutor.jsp?idPremio=' + idPremio + '&estado=' + estadoActual + '&favorito=' + nuevoFavorito)
                                            .then(response => {
                                                if (!response.ok)
                                                    throw new Error('Network response was not ok');
                                                return response.text();
...
// Función para actualizar el contenido de premios
                            function actualizarContenido() {
                                fetch('recompensas_tutor.jsp') // Realiza una llamada para obtener el contenido actualizado
...
// Función para actualizar el orden de los premios
                        ...
                        <div class = "div-container-table-scroll">
                            <table class="tabla">
                                <tr>
                                    ...
                                    <td>
                                        <div id="container-burbuja-img-text">
                                            <form action="procesa_recompensas_tutor.jsp" method="post" style="display: inline;" id="pruebapaber">
                                    ...
                                    <td id = "td-burbujas-escondidas">
                                        <form action="procesa_recompensas_tutor.jsp" method="post" style="display: inline;" id="pruebapaber2">
                        ...
                        <form action="formulario_procesa_recompensas_tutor.jsp" method="post" id="formulario-nuevo-habito">
                                ...
                                <div class="input-nombre-habito-container">
                                    <div class="juntador">
                                        <div class="flea">
                                            ...
                                            <input autocomplete="off"type="text" id="nombreHabito" name="nombreHabito" class="input-nuevo-habito" autocomplete="off" placeholder="Ingresa el nombre que llevará el premio" onfocus="showOptionsNombre()" oninput="filterOptionsNombre()">
                            ...
                            <div class="modal-separacion2">
                                ...
                                <div class="input-icon-number-container">
                                    <div class="input-wrapper">
                                        <input type="number"  autocomplete="off" autocomplete="off" style="background-image: url('../img/icono_ramita.svg'); /* Ruta de la imagen */
                            ...
                            <div class="modal-separacion4">
                                ...
                                <div>
                                    ...
                                    <textarea type="text" name="infoExtra" id="info-extra" autocomplete="off" class="input-nuevo-habito" placeholder="Ingresa información extra que quieras compartir con tu Kit sobre el hábito nuevo. No olvides ser amable y apoyarlo siempre :)"></textarea>
                ...
                <script>
                    window.onload = function () {
                        showToastPremioExistente(); // Llama a la función de mostrar el toast
                    };
                </script>
                <%
