                        ...
                        <div class="prem" >
                            ...
                            <%
                                        ...
                                        if (idPremioParam != null && favoritoParam != null) {
                                            ...
                                            // Aquí realizar la actualización en la base de datos
...
// Función para mostrar premios
                            function mostrarPremios() {
                                ...
                                if (premios.length === 0) {
                                    ...
                                    mensajeDiv.innerHTML = '<p>No hay premios sin reclamar.</p>';
...
// Función para actualizar el contenido de premios
                            function actualizarContenido() {
                                fetch('recompensas_tutor_1.jsp') // Realiza una llamada para obtener el contenido actualizado
                        ...
                        <div class = "div-container-table-scroll">
                            <table class="tabla">
                                <tr>
                                    ...
                                    <td>
                                        <div id="container-burbuja-img-text">
                                            <form action="procesa_recompesas1_tutor.jsp" method="post" style="display: inline;" id="pruebapaber">
                                    ...
                                    <td id = "td-burbujas-escondidas">
                                        <form action="procesa_recompesas1_tutor.jsp" method="post" style="display: inline;" id="pruebapaber2">
